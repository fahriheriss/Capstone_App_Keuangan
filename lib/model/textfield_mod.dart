    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIconColor: widget.dark ? Colors.black : Colors.white,
          labelText: widget.labelText,
          labelStyle:
              TextStyle(color: widget.dark ? Colors.black : Colors.white),
          ...
          focusedBorder: OutlineInputBorder(
            borderSide: BorderSide(
                color: widget.dark ? Colors.black : Colors.white, width: 2.0),
            borderRadius: widget.textArea
                ? BorderRadius.circular(10.0)
                : BorderRadius.circular(20.0),
          ),
